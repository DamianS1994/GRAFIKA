// ZADANIE_1_CW_2.cpp : Defines the entry point for the console application.
//
//Podstawa jest 14-kat
...
int main(int argc, char* argv[])
{
	...
	glutAddMenuEntry("GL_SMOOTH", GL_SMOOTH);
	glutAddMenuEntry("GL_FLAT", GL_FLAT);
